...
def run_advanced_pdo_backtest(
    ...
    *,
    ...
    players: list[AdvancedPDOPlayer] = []
    ...
    for player_id, seasons_by_stat in stats_by_player.items():
        ...
        advanced_history: list[dict[str, float]] = []
        ...
        for season in source_seasons:
            ...
            advanced_history.append(season_stats)
        ...
        players.append(
            AdvancedPDOPlayer(
                ...
                weighted_signals=build_weighted_pdo_signals(
    ...
    return build_advanced_pdo_backtest_result(
        target_season=target_season,
...
def run_advanced_pdo_aggregate(
    database: Database,
    ...
    *,
    ...
    return build_advanced_pdo_aggregate_result(results)
