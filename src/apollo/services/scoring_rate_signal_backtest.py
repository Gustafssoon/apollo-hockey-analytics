...
def run_scoring_rate_signal_backtest(
    database: Database,
    target_season: int,
    *,
    ...
    players: list[ScoringRateSignalPlayer] = []
    ...
    for player_id, seasons_by_stat in stats_by_player.items():
        ...
        for season in source_seasons:
            ...
            scoring_history.append(season_stats)
        ...
        weighted_signals = build_weighted_scoring_rate_signals(
            tuple(scoring_history),
...
def run_scoring_rate_signal_aggregate(
    database: Database,
    ...
    *,
    ...
    results = tuple(
        run_scoring_rate_signal_backtest(
            database,
            season,
    ...
    return build_scoring_rate_signal_aggregate_result(results)
